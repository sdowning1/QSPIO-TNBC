...
function params = PSA_param_in_PDAC

params.names = {};

% Cancer cell growth rate
params.names = [params.names; 'k_C1_growth'];
params.k_C1_growth.Median = log(0.0066);
...
params.initial_tumour_diameter.Median = log(2.23);
params.initial_tumour_diameter.Sigma = 0.8;
...
params.C1_PDL1_base.UpperBound = 400e6;
params.C1_PDL1_base.LowerBound = 1e6;
...
params.r_PDL2C1.UpperBound = 0.405;
params.r_PDL2C1.LowerBound = 0.0121;
...
params.r_PDL2APC.UpperBound = 0.405;
params.r_PDL2APC.LowerBound = 0.0121;
...
params.k_Mac_rec.Median = log(8*10^(-2));
...
params.C_CD47.UpperBound = 12.9;
params.C_CD47.LowerBound = 3.5;
